...
class Autocomplete extends Controller {
    ...
    function procedimentotussvalor() {

        if (isset($_GET['procedimento'])) {
            $result = $this->exametemp->listarautocompleteprocedimentotusssvalor($_GET['procedimento']);
        } else {
            $result = $this->exametemp->listarautocompleteprocedimentotusssvalor();
        }
        echo json_encode($result);
    }
