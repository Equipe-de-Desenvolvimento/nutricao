...
<? } ?>
                ...
                <li><span class="folder">Estoque</span>
                    <ul><? if ($perfil_id == 1 || $perfil_id == 8) { ?>
                            ...
                            <li><span class="file"><a href="<?= base_url() ?>estoque/inventario">Manter Inventario</a></span></li>
                            <li><span class="file"><a href="<?= base_url() ?>estoque/menu">Manter Menu</a></span></li>
                            <li><span class="file"><a href="<?= base_url() ?>estoque/tipo">Manter Tipo</a></span></li>
                            <li><span class="file"><a href="<?= base_url() ?>estoque/classe">Manter Classe</a></span></li>
                            <li><span class="file"><a href="<?= base_url() ?>estoque/subclasse">Manter Sub-Classe</a></span></li>
                            <li><span class="file"><a href="<?= base_url() ?>estoque/unidade">Manter Medida</a></span></li>
                            ...
                            <li><span class="file"><a href="<?= base_url() ?>estoque/parenteral/pesquisarestoqueparenteralgeladeira">Manter Geladeiras</a></span></li>
...
<? if ($perfil_id == 1 || $perfil_id == 5) { ?>
                            <li><span class="file"><a href="<?= base_url() ?>seguranca/operador">Listar Profissionais</a></span></li>
<? } ?>

                        <li><span class="file"><a href="<?= base_url() ?>internacao/internacao/pesquisarunidade">Listar Unidades</a></span></li>
                        <li><span class="file"><a href="<?= base_url() ?>internacao/internacao/pesquisarenfermaria">Lista Enfermarias</a></span></li>
                        <li><span class="file"><a href="<?= base_url() ?>internacao/internacao/pesquisarleito">Listar Leitos</a></span></li>

<!--                                                <li><span class="file"><a href="<?= base_url() ?>ambulatorio/agenda">Manter Agendas</a></span></li>-->
<? if ($perfil_id == 1 || $perfil_id == 3) { ?>
                            <li><span class="file"><a href="<?= base_url() ?>ambulatorio/procedimento">Manter Procedimentos</a></span></li>
                            <li><span class="file"><a href="<?= base_url() ?>ambulatorio/procedimento/relatorioprocedimento">Relatorio Procedimentos</a></span></li>
