<div class="content"> <!-- Inicio da DIV content -->
    ...
    <div id="accordion">
        <h3><a href="#">Checagem Temperatura Bolsa Parenteral Entrega</a></h3>
        <div>
            <table>
                <thead>
                    <tr>
                        ...
                        foreach ($lista as $item) {
                            ...
                            <tr>
                                ...
                                <td class="<?php echo $estilo_linha; ?>" width="60px;"><div class="bt_link_new">
                                        <a href="<?= base_url() ?>internacao/internacao/listartemperaturabolsaparenteralentrega/<?= $item->internacao_id ?>">Checar Temperatura</a></div>
                                </td>
                                <td class="<?php echo $estilo_linha; ?>" width="60px;">
                                </td>
                                <td class="<?php echo $estilo_linha; ?>" width="60px;">
