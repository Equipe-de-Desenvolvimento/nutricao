...
<div class="content"> <!-- Inicio da DIV content -->
    ...
    <div class="bt_link_new">
        <a href="<?php echo base_url() ?>internacao/internacao/novotemperaturabolsaparenteralentrega/<?=$internacao_id?>">
            Registrar Temperatura
        </a>
    </div>
    <div id="accordion">
        <h3><a href="#">Temperatura Bolsa Parenteral Entrega:</a></h3>
        <div>
            <table><!-- Início da lista de pensionistas -->
                ...
                <thead>
                    <tr>
                        ...
                        <th class="tabela_header">Responsável pelo Recebimento </th>
                ...
                <tbody>
                    ...
                    if (count($lista) > 0) :
                        ...
                        foreach ($lista as $item) {
                            ...
                            ?>
                    <tr>
                        <td class="<?=$classe;?>"><?=$item->internacao_precricao_parenteral_bolsa_entrega_id;?></td>
