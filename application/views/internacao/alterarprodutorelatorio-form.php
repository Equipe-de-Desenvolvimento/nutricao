                    ...
                    <table>
                        ...
                        <tr>
                            <td style="text-align: left">
                                ...
                                <input type="text" name="valorafaturar" id="valorafaturar" size="9" class="texto01" value="<?= $produto['0']->nome; ?>" readonly />
                            ...
                            <td style="text-align: left">
                                <input type="text" name="valorafaturar" id="valorafaturar" size="4" class="texto01" value="<?= $produto['0']->vasao; ?>" readonly />
                            ...
                            <td style="text-align: left">
                                <input type="text" name="valorafaturar" id="valorafaturar" size="7" class="texto01" value="<?= $produto['0']->peso; ?>" readonly />
