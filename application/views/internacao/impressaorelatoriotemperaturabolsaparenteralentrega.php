...
<html>
    <head>
        ...
        <title>Relatório Temp. Bolsa Parenteral Na Entrega</title>
    </head>
    ...
    <body>
        ...
        <table id="tabelaspec"  width="80%" border="0" align="center" cellpadding="0" cellspacing="0" class="tipp">
            <tbody>
                ...
                <tr class="tic">
                    <td height="16" colspan="7" class="tisemsublinhadogrande">Relatório de checagem de temperatura bolsa parenteral na entrega</td>
                </tr>
                <tr>
        ...
        <table id="tabelaspec" width="100%" border="1" align="left" cellpadding="0" cellspacing="0" class="tipp">
            ...
            <tr>
                ...
                <td width="15%" height="35" align="center" style="text-align:center;font-size: 9px;"><strong>RESPON. RECEBIM.</td>
            ...
            echo $datafinal;
                    ?></td>
                        ...
                        <td height="19" align="center" style="text-align:center;font-size: 10px;"><?= $item->responsavel_recebimento; ?></td>
