                        ...
                        foreach ($lista as $item) {
                            ...
                            <tr>
                                ...
                                <td class="<?php echo $estilo_linha; ?>" width="30px;">
                                    <a href="<?= base_url() ?>internacao/internacao/carregarunidade/<?= $item->internacao_unidade_id ?>"><center>Editar
                                                                                   </center></a>
                                </td>
                                <td class="<?php echo $estilo_linha; ?>" width="30px;">
                                    <a href="<?= base_url() ?>internacao/internacao/cadastrarprocedimentounidade/<?= $item->internacao_unidade_id ?>"><center>Procedimento
                                        </center></a>
                                </td>
                            </tr>
                        </tbody>
