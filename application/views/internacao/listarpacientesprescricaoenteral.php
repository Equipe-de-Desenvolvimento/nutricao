        ...
        <div>
            <table>
                ...
                <div class="bt_link_new">
                    <a style="cursor: pointer;" onclick="javascript:window.open('<?= base_url() . "internacao/internacao/datarepetirultimaprescicaoenteralnormal/"; ?> ', '_blank', 'toolbar=no,Location=no,menubar=no,width=1000,height=600');">Repetir Todas</a></div>
                </tr>
