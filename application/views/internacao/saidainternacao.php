<div class="content ficha_ceatox"> <!-- Inicio da DIV content -->
    <h3 class="h3_title">Saida</h3>
    <form name="form_movimentacao" id="form_unidade" action="<?= base_url() ?>internacao/internacao/gravarsaida/<?= $internacao_id; ?>" method="post">
        <fieldset>
        ...
        <fieldset>
            <legend>Motivo da Sa&iacute;da</legend>
            <div>
                    <label>TIPO</label>
                        <select name="saida" id="txtsala" class="size4">
                            <? foreach ($saida as $item) : ?>
                                <option value="<?= $item->internacao_saida_id; ?>"><?= $item->nome; ?></option>
                                    <? endforeach; ?>
                        </select>
            </div>
            <br>
