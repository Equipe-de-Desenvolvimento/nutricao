...
<table id="tabelaspec" width="80%" border="1" align="center" cellpadding="0" cellspacing="0" class="tipp">
  ...
  <tr class="tic">
    ...
    <tr>
      ...
      <td height="70" colspan="3" class="sembordadireitaesquerda"><p style="font-weight: normal; text-align: center;"><strong><?echo $empresa[0]->nome;?> <br>
                            <?echo $empresa[0]->razao_social;?><br>
                            <?echo $empresa[0]->logradouro;?> &nbsp;N:&nbsp;<?echo $empresa[0]->numero;?>&nbsp;-<?echo $empresa[0]->bairro;?> <br>
                            Telefone:<?echo $empresa[0]->telefone;?></strong>
     <br></p>
     </td>
    ...
    <tr>
     ...
     <td height="90" colspan="2" class="sembordaesquerda">(&nbsp;)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;USO DE OXIGENADORES
         ...
         <br>
         (&nbsp;)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NUTRIÇÃO ENTERAL <?$ano= substr($listar[0]->data_solicitacao,0,4);?>
...
<!--     <td height="70" colspan="1" class="sembordaesquerda">N°GIHC: <strong style="text-decoration: underline;"><?echo $listar[0]->aih;?></strong>
  ...
  <tbody>
    ...
    <tr>
      <td height="150" colspan="4" class="sembordadireita"><br>INDICAÇÃO CLINICA:ITU + DM
      <br>
      <br>
      INDICAÇÃO P/NE: RECUSA ALIMENTAR
      <br>
      <br>
      DIETA: P/CONTROLE GLICEMICO, ISENTA DE SACAROSE E LACTOSE
      <br>
      <br>
      MULTIPLAN REGULAMENTADO EM: 01/11/2001
      <br>
      <br>
      ATENDENTE: JAMILA
      <br>
