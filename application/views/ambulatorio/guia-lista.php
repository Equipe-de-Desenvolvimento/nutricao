            ...
            <thead>
                <tr>
                    <th class="tabela_header">Guia: <?= $test->ambulatorio_guia_id ?></th>
                                                ...
                                                <th class="tabela_header"><div class="bt_linkf">
                                                <a onclick="javascript:window.open('<?= base_url() . "ambulatorio/guia/faturarguia/" . $guia_id; ?> ', '_blank', 'toolbar=no,Location=no,menubar=no,width=600,height=500');">Faturar Guia
