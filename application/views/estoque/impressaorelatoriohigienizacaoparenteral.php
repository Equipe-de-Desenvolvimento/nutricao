...
<html>
    <head>
        ...
        <title>Relatório Entrada Sala de Higienização</title>
    </head>
    ...
    <body>
        ...
        <table id="tabelaspec"  width="80%" border="0" align="center" cellpadding="0" cellspacing="0" class="tipp">
            <tbody>
                ...
                <tr class="tic">
                    <td height="16" colspan="7" class="tisemsublinhadogrande">Relatório de entrada na sala de higienização parenteral</td>
                </tr>
                <tr>
