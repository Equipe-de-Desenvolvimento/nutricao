<div class="content"> <!-- Inicio da DIV content -->
    ...
    <table>
        <thead>
            ...
            <? if (count($empresa) > 0) { ?>
                <tr>
                    <th style='text-align: left; font-family: serif; font-size: 12pt;' colspan="4"><?= utf8_decode($empresa[0]->razao_social); ?></th>
                </tr>
                <?
            ...
            ?>
            <tr>
                <th style='text-align: left; font-family: serif; font-size: 12pt;' colspan="4">ENTRADA DE PRODUTOS</th>
            </tr>
            <tr>
            ...
            <tr>
                <th style='text-align: left; font-family: serif; font-size: 12pt;' colspan="4">EMPRESA: <?= utf8_decode($tipoempresa); ?></th>
            </tr>
