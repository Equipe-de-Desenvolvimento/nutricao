...
<html>
    <head>
        ...
        <title>Relatório Temp. Umidade. Estoque Parenteral</title>
    </head>
    ...
    <body>
        ...
        <table id="tabelaspec"  width="80%" border="0" align="center" cellpadding="0" cellspacing="0" class="tipp">
            <tbody>
                ...
                <tr class="tic">
                    <td height="16" colspan="7" class="tisemsublinhadogrande">Relatório de checagem de temperatura e umidade do estoque parenteral</td>
                </tr>
                <tr>
        ...
        <table id="tabelaspec" width="100%" border="1" align="left" cellpadding="0" cellspacing="0" class="tipp">
            ...
            <tr>
                ...
                <td width="10%" height="35" align="center" style="text-align:center;font-size: 9px;"><strong>UMIDADE</td>
                <td width="30%" height="35" align="center" style="text-align:center;font-size: 9px;"><strong>OBSERVAÇÕES</td>
            ...
            echo $datafinal;
                    ?></td>
                        ...
                        <td height="19" align="center" style="text-align:center;font-size: 10px;"><?= $item->umidade; ?> %</td>
                        <td height="19" align="center" style="text-align:center;font-size: 10px;"><?= $item->observacao; ?></td>
