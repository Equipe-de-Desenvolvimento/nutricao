...
<div class="content"> <!-- Inicio da DIV content -->
    ...
    <div class="bt_link_new">
        <a href="<?php echo base_url() ?>estoque/parenteral/registrartemperatura/<?=$estoque_parenteral_geladeira_id;?>">
            ...
            <table><!-- Início da lista de pensionistas -->
                ...
                <thead>
                    <tr>
                        ...
                        <th class="tabela_header">Temperatura </th>
                ...
                <tbody>
                    ...
                    if (count($lista) > 0) :
                        ...
                        foreach ($lista as $item) {
                            ...
                            ?>
                    <tr>
                        <td class="<?=$classe;?>"><?=$item->estoque_parenteral_geladeira_temperatura_id;?></td>
                        ...
                        <td class="<?=$classe;?>"><?=$item->temperatura;?> C°</td>
                        ...
                        ?>
                    <tr>
                        <td class="tabela_content01" colspan="4">Sem Temperatura cadastrada.</td>
                    </tr>
                    <? endif; ?>
              </tbody>
                <tfoot>
                    <tr>
                        <th class="tabela_footer" colspan="6">Temperaturas <?=count($lista); ?></th>
                    </tr>
                </tfoot>
