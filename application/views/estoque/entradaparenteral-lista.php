    ...
    <div id="accordion">
        ...
        <div>
            ...
            <table>
                ...
                $consulta = $this->parenteral->listar($_GET);
                ...
                if ($total > 0) {
                    ...
                    <tbody>
                        <?php
                        $lista = $this->parenteral->listar($_GET)->limit($limit, $pagina)->get()->result();
                        ...
                        foreach ($lista as $item) {
                            ...
                            <tr>
                                ...
                                <td class="<?php echo $estilo_linha; ?>" width="50px;">
                                    ...
                                    <a href="<?= base_url() ?>estoque/parenteral/entradaestoqueparenteral/<?=$item->estoque_saida_id;?>">Entrada</a></div>
                                </td>
                            </tr>
