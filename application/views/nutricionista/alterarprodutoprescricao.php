...
<div class="content ficha_ceatox"> <!-- Inicio da DIV content -->
    ...
    <form name="form_exame" id="form_exame" action="<?= base_url() ?>nutricionista/nutricionista/gravaralterarprodutoprescricao/<?= $internacao_precricao_produto_id; ?>" method="post">
        <fieldset>
