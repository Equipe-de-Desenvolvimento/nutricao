...
//            die;
    ...
    function listarautocompleteprocedimentotusssvalor($parametro = null) {
        $this->db->select('t.valor');
        $this->db->from('tb_tuss t');
        $this->db->join('tb_procedimento_tuss pt', 'pt.tuss_id = t.tuss_id');
        $this->db->where('pt.procedimento_tuss_id', $parametro);
        $return = $this->db->get();
        return $return->result();
    }
