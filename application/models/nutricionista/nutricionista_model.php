...
class nutricionista_model extends BaseModel {
    ...
    function nutricionista_model($paciente_id = null) {
        parent::Model();
...
//        $this->db->where('ip.data', $data);
    ...
    function gravarprodutoantigoprescricao($internacao_precricao_produto_id) {
